...
test("should create a new tooltip", () => {
  document.body.innerHTML =
    '<div class="container_tooltip"><header class="header_tooltip"><p class="title_tooltip">Вот и птичка ;)</p></header><div class="content_tooltip"><p class="message_tooltip">Спасибо, что выпустил птичку на волю!</p></div></div>';
